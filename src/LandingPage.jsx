    ...
    <div className="bg-gradient-to-b from-purple-900 to-purple-700 text-white min-h-screen flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center flex-grow text-center px-4">
        ...
        <p className="text-lg mb-8">
          Simplify your JWT authentication process for APIs. Use our intuitive web client or download the desktop client for an enhanced experience.
        </p>
        
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
          <Link to="/login" className="bg-purple-500 hover:bg-purple-400 text-white font-bold py-3 px-8 rounded-lg shadow-md transition duration-300 text-center">
            Use Web Client
          </Link>
          <a 
            href={AuthratorExe} 
