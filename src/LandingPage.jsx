  ...
  return (
    <div className="bg-gradient-to-b from-purple-900 to-purple-700 text-white min-h-screen flex flex-col">
      ...
      <footer className="py-6 bg-purple-900 text-center">
        <p>&copy; {new Date().getFullYear()} Authrator. All rights reserved. | <a href="https://docs.authrator.app/" className='underline'>Documentation</a> | <Link to="/privacy-policy" className="underline">Privacy Policy</Link> | <Link to="/terms-of-service" className="underline">Terms of Service</Link></p>
      </footer>
